...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Italian Dishes App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Italian Dishes App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Italian Dishes App Login', user : req.user }); 
}); 
